...
export const mockLeads: Lead[] = [
  ...
  },
  {
    ...
    sdrOwner: 'Carlos SDR',
    nextActionAt: new Date(Date.now() + 3600000).toISOString(),
  ...
  },
  {
    ...
    sdrOwner: 'Carlos SDR',
    nextActionAt: new Date(Date.now() + 4 * 86400000).toISOString(),
...
export const mockWebhooks: Webhook[] = [
  {
    id: 'w1',
    name: 'Integrações comerciais',
    url: 'https://integracoes.enervita.com.br/webhook/leads',
